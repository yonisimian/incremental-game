...
const choiceUpgrades: readonly UpgradeDefinition[] = [
  { id: 'choice-a', cost: 1, purchaseLimit: 1, modifiers: [], choiceGroup: 'branch' },
  { id: 'choice-b', cost: 1, purchaseLimit: 1, modifiers: [], choiceGroup: 'branch' },
  { id: 'normal', cost: 1, purchaseLimit: 1, modifiers: [] },
]
...
describe('validateUpgradeChoiceGroups', () => {
  ...
  it('rejects an empty choiceGroup identifier', () => {
    const invalid: UpgradeDefinition[] = [
      { id: 'bad', cost: 1, purchaseLimit: 1, modifiers: [], choiceGroup: '' },
    ]
    expect(() => {
