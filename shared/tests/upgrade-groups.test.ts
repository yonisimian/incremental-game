...
const choiceUpgrades: readonly UpgradeDefinition[] = [
  { id: 'choice-a', cost: { r0: { baseCost: 1 } }, purchaseLimit: 1, choiceGroup: 'branch' },
  { id: 'choice-b', cost: { r0: { baseCost: 1 } }, purchaseLimit: 1, choiceGroup: 'branch' },
  { id: 'normal', cost: { r0: { baseCost: 1 } }, purchaseLimit: 1 },
]
...
describe('validateUpgradeChoiceGroups', () => {
  ...
  it('rejects an empty choiceGroup identifier', () => {
    const invalid: UpgradeDefinition[] = [
      { id: 'bad', cost: { r0: { baseCost: 1 } }, purchaseLimit: 1, choiceGroup: '' },
    ]
    expect(() => {
