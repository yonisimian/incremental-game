...
import { goalTypeOf, simResultsToScores } from '../src/balance/project.js'
import type { TargetEnvelope } from '../src/balance/types.js'
import { IDLER_TIMED_ENVELOPE } from '../src/modes/idler-envelope.js'
...
describe('envelopeFor', () => {
  ...
  it('returns undefined for an unregistered combination', () => {
    expect(envelopeFor('idler', 'target-score')).toBeUndefined()
  })
})
